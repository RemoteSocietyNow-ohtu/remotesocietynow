...
//Handles GET requests to (baseUrl)/api/questions/people/ , responds with the list of questions to show in the site
questionRouter.get('/people/', (req, res) => {
  questionsPeople.map((question, i) => questionsPeople[i].number = i)
  res.json(questionsPeople)
})

//Handles GET requests to (baseUrl)/api/questions/company/ , responds with the list of questions to show in the site
...
//Handles GET requests to (baseUrl)/api/questions/people/id , responds with the (id):th question
